...
{ 
  ...
  public void makeDeck()
  {
    ...
    //calls upon actual war game
    warConcept();
    
  }
  //actual war game
  public void warConcept()
  {
    ...
    try{
      ...
      while (cont == 1 && player1.size() != 0 && player2.size() != 0)
      {
        ...
        System.out.println("Computer has " + player2.size() + " cards.");
        ...
        if (play1 > play2)
        {
          ...
          System.out.println ("Player 1 picked " + (player1.get(0) + 1) + " and player 2 picked " + (player2.get(0)+1) + ", player 1 wins");
        ...
        else if (play1 < play2)
        {
          ...
          System.out.println ("Player 1 picked " + (player1.get(0)+ 1) + " and player 2 picked " + (player2.get(0)+ 1) + ", player 2 wins");
          //adds cards to winner
        ...
        else if (play1 == play2)
        {
          ...
          {
            //displays cards
            System.out.println ("Player 1 picked " + (player1.get(0)+ 1) + " and player 2 picked " + (player2.get(0)+ 1));
            ...
            System.out.println ("Player 1 picked up another 3 cards: \n" + (player1.get(1)+ 1) + "\n" + (player1.get(2)+ 1) + "\n" + (player1.get(3)+ 1) );
            System.out.println ("Player 2 picked up another 3 cards: \n" + (player2.get(1)+ 1) + "\n" + (player2.get(2)+ 1) + "\n" + (player2.get(3)+ 1) );
            ...
            else if (play1 == play2)
            {
              ...
              System.out.println ("It's a tie still");
            }
          }
        }
      ...
      if (player1.size() == 0)
      {
        System.out.println ("Player 2 wins this game of War");
      }
      //runs if player 2 has no cards left
      else if (player2.size() == 0)
      {
        System.out.println ("Player 1 wins this game of War");
      }
      // ends game
      else if (cont == 2)
      {
